...
public class TextDB extends DBBase{
...
//    private static final String NOTE_TYPE= "type";
    ...
    public static void createTableNote(SQLiteDatabase sqLiteDatabase) {
        String query = "CREATE TABLE NoteModel (" + "id" + " INTEGER PRIMARY KEY AUTOINCREMENT, " + "des" + " TEXT)";
